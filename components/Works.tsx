      ...
      <div className="px-10 md:px-20 py-12 md:py-20">
        <div className="mb-5">
          ...
          >
            ...
            <p className="text-slate-600 mt-3 text-sm leading-relaxed">
              Some projects and products I have built while learning,
        ...
        {projectsData.map((data, index) => (
          <div key={data.id}>
              ...
              <div className="flex-1">
                  ...
                  <div className="flex w-full flex-wrap gap-2">
                    {data.techStack.map((d) => (
                      <Badge
                        key={d}
                        variant="outline"
                        className="bg-primary text-xs md:text-sm text-white"
                      >
                        {d}
                      </Badge>
                    ))}
                ...
                <div className="mt-5">
                  <a
                    ...
                    className="px-3 py-2 rounded-md bg-primary text-white text-xs md:text-sm"
                  >
                    View Project
                  </a>
                </div>
            ...
            {index !== projectsData.length - 1 && <hr className="my-10" />}
          </div>
        ))}
      </div>
    </ScrollReveal>
